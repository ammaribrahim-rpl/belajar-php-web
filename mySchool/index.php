                        ...
                        <form class="p-4 md:p-5" action="" method="post">
                            <div class="grid gap-4 mb-4 grid-cols-3">
                                ...
                                <div class="col-span-1 sm:col-span-1">
                                    ...
                                    <input type="number" min="0" max="100" name="umur" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type Age" required="">
                                </div>
